			...
			<div className="hosts-empty-state-container-content">
				...
				{noData && (
					<div className="no-hosts-message">
						...
						<Typography.Text className="no-hosts-message-text">
							...
							. Please refer to{' '}
							<a
								href="https://conoscense.io/docs/userguide/hostmetrics"
								target="_blank"
								rel="noreferrer"
							>
								this
							</a>{' '}
							to learn how to send host metrics to conoscense.
						</Typography.Text>
					</div>
				)}
				...
				{incorrectData && (
					<Typography.Text className="incorrect-metrics-message">
						To see host metrics, upgrade to the latest version of conoscense k8s-infra
