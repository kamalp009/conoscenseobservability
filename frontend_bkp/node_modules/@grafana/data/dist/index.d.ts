import { TimeZone as TimeZone$1, TimeZoneBrowser as TimeZoneBrowser$1, TimeZoneUtc as TimeZoneUtc$1, MatcherConfig, DataQuery as DataQuery$1, DataSourceRef as DataSourceRef$1, DataTopic, DataTransformerConfig, AnnotationQuery as AnnotationQuery$1, DataSourceJsonData as DataSourceJsonData$1, HideSeriesConfig, MapLayerOptions, SortOrder, ComparisonOperation } from '@grafana/schema';
...
type PluginAddedLinksConfigureFunc<Context extends object> = (context: Readonly<Context> | undefined, helpers: PluginExtensionHelpers) => Partial<{
    title: string;
    description: string;
    path: string;
...
declare namespace datemath_d {
  export { datemath_d_isMathString as isMathString, datemath_d_isValid as isValid, datemath_d_parse as parse, datemath_d_parseDateMath as parseDateMath, datemath_d_roundToFiscal as roundToFiscal };
}
