...
class FunctionalVector {
  ...
  *iterator() {
  ...
  [(_b$1 = Symbol.iterator, _a$1 = Symbol.unscopables, _b$1)]() {
      ...
      operators.map((data) => {
        ...
        switch (mode) {
          ...
          case "binary" /* BinaryOperation */:
            ...
            const binaryOptions = {
              left: checkBinaryValueType((_c = (_b = options.binary) == null ? void 0 : _b.left) != null ? _c : "", fieldNames),
              operator: (_e = (_d = options.binary) == null ? void 0 : _d.operator) != null ? _e : defaultBinaryOptions.operator,
              right: checkBinaryValueType((_g = (_f = options.binary) == null ? void 0 : _f.right) != null ? _g : "", fieldNames)
            };
            options.binary = binaryOptions;
            if (((_i = (_h = binaryOptions.left) == null ? void 0 : _h.matcher) == null ? void 0 : _i.id) && ((_j = binaryOptions.left) == null ? void 0 : _j.matcher.id) === FieldMatcherID.byType) {
                ...
                frame.fields.map((field, index) => {
                  ...
                  if (field.type === fieldType) {
                    ...
                    const right = findFieldValuesWithNameOrConstant(
                      frame,
                      (_a2 = binaryOptions.right) != null ? _a2 : defaultBinaryOptions.right,
                      data,
                      ctx
                    );
                    ...
                    const newField = {
                      ...field,
                      name: `${field.name} ${(_c2 = (_b2 = options.binary) == null ? void 0 : _b2.operator) != null ? _c2 : ""} ${(_g2 = (_e2 = (_d2 = options.binary) == null ? void 0 : _d2.right.matcher) == null ? void 0 : _e2.options) != null ? _g2 : (_f2 = options.binary) == null ? void 0 : _f2.right.fixed}`,
                      values: arr
                    };
