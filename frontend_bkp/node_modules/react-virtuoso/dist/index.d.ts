...
export declare type FixedFooterContent = (() => ReactNode) | null;

export declare type FixedHeaderContent = (() => ReactNode) | null;
...
export declare type GridRootProps = Omit<HTMLProps<HTMLDivElement>, 'ref' | 'data'>;
...
export declare type ListRootProps = Omit<HTMLProps<HTMLDivElement>, 'ref' | 'data'>;
...
export declare type TableRootProps = Omit<HTMLProps<HTMLTableElement>, 'ref' | 'data'>;
...
export declare const VirtuosoGridMockContext: Context<VirtuosoGridMockContextValue | undefined>;
...
export declare const VirtuosoMockContext: Context<VirtuosoMockContextValue | undefined>;
